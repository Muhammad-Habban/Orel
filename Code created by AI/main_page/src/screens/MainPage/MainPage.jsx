      ...
      <div className="div">
        <div className="overlap">
          ...
          <a href="https://www.linkedin.com/in/orel-shmueli/" rel="noopener noreferrer" target="_blank">
            <img className="logo-linkedin" alt="Logo linkedin" src="/img/logo-linkedin.svg" />
          </a>
          ...
          <div className="thumbnail">
            <div className="figma">
              <img className="figma-logo" alt="Figma logo" src="/img/figma-logo-e4e21d3aea-seeklogo-1.png" />
            </div>
            ...
            <div className="group-5">
              ...
              <div className="group-6">
                <a
                  ...
                  target="_blank"
                />
                <div className="text-wrapper-4">cv</div>
              </div>
            </div>
          </div>
        </footer>
