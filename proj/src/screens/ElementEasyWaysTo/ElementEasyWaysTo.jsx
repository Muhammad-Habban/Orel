...
export const ElementEasyWaysTo = () => {
  ...
  return (
    <>
          ...
          <div className="overlap">
            ...
            <div className="frame-2">
              <p className="propuesta-de-concept">
                ...
                developers?
                <br />
                Don Norman (the writer of The Design of Everyday Things) claims
                that designers and developers have different perceptions of how
                people think and act. These differences affect the types of
                solutions we offer our users (aka people). We also have
                different roles in the product planning and building cycle.
                Engineers need to think about being efficient, while designers
                need to create a better experience for users. But are we really
                <br />
                that different?
              </p>
              <p className="p">
              ...
              <p className="p">
                ...
                you’re a developer and you find it interesting, I invite you to
                share it with the designers at your company.
              </p>
            </div>
          </div>
            ...
            <div className="frame-3">
              <div className="frame-4">
                <p className="propuesta-de-concept">
                  ...
                  not our private room, so we can&#39;t leave a bunch of clothes
                  on the chair and a messy closet behind us. Developers can
                  relate to that because they need to keep their code neat for
                  others to review or work on. As designers, we are familiar
                  with our design files, but for anyone else, it might be
                  overwhelming to go over all those screens and pages. This cool
                  method will help developers find what they need easily.
                </p>
                <p className="p">
                  {" "}
              ...
              <div className="frame-4">
                <p className="propuesta-de-concept">
                  ...
                  You should make sure to put only the required screens for each
                  task on its file. <br />
              ...
              <div className="frame-4">
                ...
                <p className="propuesta-de-concept-7">
                  ...
                  <span className="text-wrapper-3">
                    ...
                    It’s also a good opportunity to give each other feedback and
                    ask questions. <br />
                    <br />
                  </span>
                  <span className="span">
            ...
            <div className="frame-3">
              <div className="frame-4">
                <p className="propuesta-de-concept">
                  ...
                  important to hear each other&#39;s thoughts and comments.
                  Working on our communication is an ongoing process, and
                  I&#39;m still working on it every day. If you have useful tips
      ...
      <motion.div className="ElementWays-query-builder-2">
        <div className="ElementWays-over-query-builder">
          <div className="ElementWays-first-divison ElementWays-first-part">
            ...
            <div className="ElementWays-big-para">
              ...
              that designers and developers have different perceptions of how
              people think and act. These differences affect the types of
              solutions we offer our users (aka people). We also have different
              roles in the product planning and building cycle. Engineers need
              to think about being efficient, while designers need to create a
              better experience for users. But are we really that different?
            </div>
            <div className="ElementWays-big-para">
              Norman himself was an engineer and then became a designer. Tim
              Brown (the writer of “Design Thinking”) claimed that Isambard
              Kingdom Brunel (an engineer) is the first design thinker. Both
              designers and engineers are needed to create better products. So,
              how to overcome our communication challenges?
            </div>
            <div className="ElementWays-big-para">
              At Authomize, we’ve managed to find 3 things that improved our
              collaboration greatly. Those 3 easy to follow steps, can help you
              create an organized and inclusive framework. I’m a designer, so
              some of the steps are up to the designers in your organization to
              follow. But if you’re a developer and you find it interesting, I
              invite you to share it with the designers at your company.
            </div>
          </div>
        </div>
        <div className="ElementWays-first-divison ElementWays-second-part">
          <img className="ElementWays-inven" src="/img/image-17.png" alt="#" />
        </div>
        ...
        <div className="ElementWays-col-content">
          ...
          <div className="ElementWays-big-para">
            One of the most important things when working with others is to be
            organized. Figma (or any other system you’re using) is not our
            private room, so we can't leave a bunch of clothes on the chair and
            a messy closet behind us. Developers can relate to that because they
            need to keep their code neat for others to review or work on. As
            designers, we are familiar with our design files, but for anyone
            else, it might be overwhelming to go over all those screens and
            pages. This cool method will help developers find what they need
            easily.
          </div>
          <div className="ElementWays-big-para">
            Open a new project in Figma for designs hand-offs, and call it
            “sprints” In this project, each sprint should get a file (sprint 1,
            sprint 2, and so on). Use the first page of each file as a cover to
            keep everything organized. (I like to write on the cover the name
            and time range of each sprint).
          </div>
        </div>
        ...
        <div className="ElementWays-big-para">
          On the sprint file, each page is a task, and the page name must match
          the task's name as it's written on Jira. You should make sure to put
          only the required screens for each task on its file. Update the design
          link on the task story. By doing so you’re connecting between the two
          platforms, making it easy for developers to find the design they need.
          For the final touch, you can use the new Jira widget that Figma
          released (it’s brilliant). This one is more for you (designers). It
          helps keep you in the loop, by showing you how's going to work on this
        ...
        <div className="ElementWays-col-content">
          ...
          <div className="ElementWays-big-para">
            Ok, so you don’t have to become best friends, but continuous
            communication is important. To maintain it you should do two things:
          </div>
          <div className="ElementWays-blue-h">
            1. Include each other in your daily meetings.
          </div>
          <div className="ElementWays-big-para">
            In Authomize, the front-end developers are having daily stand-ups.
            Including me in those meetings, created an opportunity for us to
            update each other on a daily basis. It’s also a good opportunity to
            give each other feedback and ask questions.
          </div>
          <div className="ElementWays-blue-h">
            2. Move your seats next to each other
          </div>
          <div className="ElementWays-big-para">
            Sitting close allows you to use those free times between meetings to
            catch up. If you’re working from home, you can set a weekly meeting
            for mutual updates.
          </div>
        </div>
        ...
        <div className="ElementWays-col-content">
          ...
          <div className="ElementWays-big-para">
            Ok, I’ll admit that this one is not that easy to create, but I
            promise you it’s worth your time. Having a design system has tons of
            advantages. A design system is a collection of UI components and
            design guidelines that are being used in your organization. It’s an
            amazing tool to keep the design consistent and leaves no room for
            improvisation. It saves time and helps with onboarding new members
            to both teams.
          </div>
          <div className="ElementWays-big-para">
            It’s also something you can build together, designers and
            developers. Make sure both are agreeing on the complexity of new
            components, how to organize it, and make it accessible to both
            teams. At Authomize, the lead front-end developer and I had weekly
            design system meetings. During those meetings, we planned each
            section of the design system. After the meetings, I designed it as
            we planned together. Keeping him in the flow helped a lot with the
            implementation process. He felt that this is his project as much as
            it is mine and it made him motivated to implement it faster.
          </div>
        </div>
        <div className="ElementWays-first-divison ElementWays-second-part">
          <img
        ...
        <div className="ElementWays-col-content">
          ...
          <div className="ElementWays-big-para">
            We might be different but we have one thing in common, we both want
            to feel included. Those tips can help you create an organized
            framework. But you should keep in mind that it's important to hear
            each other's thoughts and comments. Working on our communication is
            an ongoing process, and I'm still working on it every day. If you
