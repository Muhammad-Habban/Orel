        ...
        <div className="ElementWays-outer-div">
          ...
          <div className="ElementWays-query-builder-2">
            ...
            <div className="ElementWays-col-content">
              ...
              <div className="ElementWays-big-para">
                One of the most important things when working with others is to
                be organized. Figma (or any other system you’re using) is not
                our private room, so we can't leave a bunch of clothes on the
                chair and a messy closet behind us. Developers can relate to
                that because they need to keep their code neat for others to
                review or work on. As designers, we are familiar with our design
                files, but for anyone else, it might be overwhelming to go over
                all those screens and pages. This cool method will help
                developers find what they need easily.
              </div>
              <div className="ElementWays-big-para">
                Open a new project in Figma for designs hand-offs, and call it
                “sprints” <br /> In this project, each sprint should get a file
                (sprint 1, sprint 2, and so on). <br /> Use the first page of
                each file as a cover to keep everything organized. (I like to
                write on the cover the name and time range of each sprint).
              </div>
            </div>
            ...
            <div className="ElementWays-big-para">
              ...
              match the task&#39;s name as it&#39;s written on Jira. You should
              make sure to put only the required screens for each task on its
              file. <br />
              Update the design link on the task story. By doing so you’re
              connecting between the two platforms, making it easy for
              developers to find the design they need. <br />
              ...
              work on this design and the feature implementation status without
              leaving Figma.
            </div>
            <div className="ElementWays-first-divison ElementWays-second-part">
              <div>
            ...
            <div className="ElementWays-col-content">
              ...
              <div className="ElementWays-big-para">
                Sitting close allows you to use those free times between
                meetings to catch up. If you’re working from home, you can set a
                weekly meeting for mutual updates.
              </div>
            </div>
            ...
            <div className="ElementWays-col-content">
              ...
              <div className="ElementWays-big-para">
                ...
                tons of advantages. A design system is a collection of UI
                components and design guidelines that are being used in your
                organization. It’s an amazing tool to keep the design consistent
                and leaves no room for improvisation. It saves time and helps
                with onboarding new members to both teams.
              </div>
              <div className="ElementWays-big-para">
                It’s also something you can build together, designers and
                ...
                teams. At Authomize, the lead front-end developer and I had
                weekly design system meetings. During those meetings, we planned
                each section of the design system. After the meetings, I
                designed it as we planned together. Keeping him in the flow
                helped a lot with the implementation process. He felt that this
                is his project as much as it is mine and it made him motivated
            ...
            <div className="ElementWays-col-content">
              ...
              <div className="ElementWays-big-para">
                ...
                want to feel included. Those tips can help you create an
                organized framework. But you should keep in mind that it's
                important to hear each other's thoughts and comments. Working on
                our communication is an ongoing process, and I'm still working
                on it every day. If you have useful tips I'd love to hear them.
              </div>
            </div>
          </div>
        </div>
