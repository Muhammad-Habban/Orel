...
export const ElementEasyWaysTo = () => {
  ...
  return (
    <motion.div
      className="element-easy-ways-to"
    >
      <div className="div">
        <div className="overlap">
          ...
          <div className="frame-2">
            <p className="propuesta-de-concept">
              ...
              better experience for users. But are we really
              <br />
              that different?
            </p>
            <p className="p">
            ...
            <p className="p">
              ...
              <br />
              Those 3 easy to follow steps, can help you create an organized and
              inclusive framework. I’m a designer, so some of the steps are up
              to the designers in your organization to follow. But if you’re a
              developer and you find it interesting, I invite you to share it
              with the designers at your company.
            </p>
          </div>
        </div>
          ...
          <div className="frame-3">
            <div className="frame-4">
              <p className="propuesta-de-concept">
                ...
                our private room, so we can&#39;t leave a bunch of clothes on
                the chair and a messy closet behind us. Developers can relate to
          ...
          <div className="frame-3">
            <div className="frame-4">
              <p className="propuesta-de-concept">
                ...
                Working on our communication is an ongoing process, and I&#39;m
                still working on it every day. If you have useful tips I&#39;d
                love to hear them.
              </p>
            </div>
          </div>
