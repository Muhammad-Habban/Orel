...
export const QueryBuilder = () => {
  ...
  return (
    <>
        ...
        <div className="div">
          <div className="overlap">
            ...
            <p className="propuesta-de-concept">
              ...
              complex relationships between the data. As a result, querying this
              data can be a challenging and time-consuming task. Query builders
              provide a way to simplify this process for our users.
            </p>
            ...
            <div className="group">
              <p className="text-wrapper">
                One of my favorite projects as a product designer was the design
                of a query builder for Authomize. As a complex system designer,
                I was faced with the challenge of creating a tool for filtering
                and organizing large sets of data in an intuitive and
                user-friendly way. The query builder needed to be able to handle
                a variety of data types, each with their own specific categories
                and hierarchies. I enjoyed the process of brainstorming and
                prototyping different solutions, and ultimately delivering a
                product that not only met the needs of the user, but exceeded
                their expectations. The query builder has since become an
                integral part of Authomize&#39;s platform, and I am proud of the
                role I played in its development.
              </p>
          ...
          <div className="group-6">
            <p className="p">
              ...
              are typically CISOs, security architects, compliance managers, and
              SOC analysts who rely on our platform to securely and effectively
              handle their organizational needs.
            </p>
            ...
            <div className="frame-wrapper">
              <div className="frame-3">
                ...
                <p className="propuesta-de-concept-4">
                  ...
                  product managers to establish a clear set of requirements and
                  a defined timeline. From there, we work collaboratively to
                  brainstorm and prototype solutions, testing and iterating
                  along the way to ensure that the final product meets the needs
                  of our users.
                </p>
              </div>
            </div>
            ...
            <div className="group-8">
              ...
              <div className="group-9">
                <div className="frame-3">
                  ...
                  <p className="propuesta-de-concept-4">
                    <span className="span">
                      Before diving into the design process, I like to start by
                    ...
                    <span className="span">
                      : This involves learning about best practices and reading
                      articles about similar features to get a sense of what has
                    ...
                    <span className="span">
                      ...
                      have tackled similar problems and gather inspiration from
                      their approaches. This helps me to understand what has
                      already been done so that I can design something that our
                      users will be able to learn quickly how to use at.
                    </span>
                  </p>
                </div>
              </div>
            ...
            <div className="group-10">
              ...
              <div className="group-12">
                <p className="propuesta-de-concept-5">
                  ...
                  <br />
                  When something returns zero results, hide this option from the
                  filter
                  <br />
                  all applied filters should work asynchronously and don’t black
                  out the page experience
                  <br />
              ...
              <div className="group-13">
                <p className="propuesta-de-concept-5">
                  ...
                  design of the query builder was no exception. I like to write
                  to myself at the beginning of each project what are the
                  biggest challenges. Some of the key challenges I faced in this
                  project included:
                  <br />
                  Maintaining consistency: As a complex system, our product has
                  many different parts that use filters with varying
                  ...
                  options and possibilities could be overwhelming and confusing.
                  <br />
                  Achieving the main purpose: Ultimately, the goal of the query
                  builder was to filter data in the most efficient way possible.
                  It was important to consider this purpose and design the tool
                  in a way that met this need effectively.
                </p>
                  ...
                  <div className="group-15">
                    ...
                    <p className="propuesta-de-concept-8">
                      ...
                      <span className="text-wrapper-7">
                        This means that users prefer your site to work the same
                        way as all the other sites they already know”.
                      </span>
                    </p>
                  </div>
                  <p className="propuesta-de-concept-9">
                    To understand how our users interact with other products, I
                    like to show the product managers examples of complex
                    filters that I find useful and have them use them while I
                    observe. This helps me to get a better understanding of the
                    user experience and identify any potential pain points.
                    <br />
                    <br />
                    Once I have gathered all of this information, I move on to
                    the fun part: sketching and planning. This is where I get to
                    be creative and start exploring different design concepts
                    and ideas.
                  </p>
                </div>
                ...
                <div className="group-22">
                  <div className="overlap-group-3">
                    <p className="propuesta-de-concept-11">
                      ...
                      <br />
                      When the filter is in edit mode: display the full list of
                      systems with a small X icon to delete the relevant system
                      <br />
                      When the filter is active and not in an edit mode: display
                      up to one item and a number of other selected items (i.e
                      System: Microsoft (google, GitHub) =&gt; System: Microsoft
                      + 2)
                      <br />
                      What happened if the dropdown is open? as long as the user
                      hasn’t clicked anywhere the dropdown is open
                      <br />
                      When the filter is applied in the filters list without any
                      select option we should display “all”
                    </p>
          ...
          <div className="group-23">
            <p className="propuesta-de-concept-13">
              Adding filters: by clicking a plus button a menu with the filters
              types will pop.
              <br />
              ...
              <br />
              <br />
              All filters should be URL-based, so the user can refresh the page
              or send it to another person with the filters applied.
              <br />
            ...
            <div className="overlap-4">
              ...
              <div className="group-30">
                <p className="propuesta-de-concept-15">
                  ...
                  potential challenges that need to be addressed before testing
                  prototypes with users. In the case of the query builder, some
                  of the specific concerns we had included:
                  <br />
                  Users might not be able to find the &#34;Add Filter&#34;
                  button, which is revealed when the user hovers over the filter
                  area
                  <br />
                  ...
                  experience, we conducted usability tests with a small group of
                  customers (typically 3-5 individuals). As a small-medium
                  ...
                  understanding the different filter categories and options. As
                  a result, we made the decision to add explanations and
                  definitions of each filter to the menu to help users better
                  understand their options and choose the right filter for their
                  needs.
                </p>
                <p className="propuesta-de-concept-16">
                  ...
                  the development team to go over the design together and answer
                  any questions they may have. I also make sure to provide clear
                  organization and labeling of design assets in tools like Figma
                  to make it easy for developers to find what they need.
                  <br />
                  <br />
      ...
      <motion.div className="query-builder-2">
        ...
        <div className="second-division">
          ...
          <div className="big-para">
            One of my favorite projects as a product designer was the design of
            a query builder for Authomize. As a complex system designer, I was
            faced with the challenge of creating a tool for filtering and
            organizing large sets of data in an intuitive and user-friendly way.
            The query builder needed to be able to handle a variety of data
            types, each with their own specific categories and hierarchies. I
            enjoyed the process of brainstorming and prototyping different
            solutions, and ultimately delivering a product that not only met the
            needs of the user, but exceeded their expectations. The query
            builder has since become an integral part of Authomize's platform,
        ...
        <div className="fourth-division">
          ...
          <div className="another-para">
            Our product is a SaaS solution designed to help companies
            efficiently manage their identities, data, and access. Our users are
            typically CISOs, security architects, compliance managers, and SOC
            analysts who rely on our platform to securely and effectively handle
        ...
        <div className="fifth-division">
          ...
          <div className="inside-flex">
            <div className="first-img">
              <img class="in-first" alt="Group" src="/img/group-4252.png" />
            </div>
            <div className="second-img">
              <img class="in-second" alt="Group" src="/img/group-41.png" />
            </div>
          </div>
        </div>
        <div className="sixth-divison">
          ...
          <div className="one-of-sixth">
            ...
            <div className="col-content">
              ...
              <div className="para-kick">
                As a product designer on the product team, I follow a structured
                process to ensure that each project is delivered successfully.
                This process starts with meeting with the product managers to
                establish a clear set of requirements and a defined timeline.
                From there, we work collaboratively to brainstorm and prototype
                solutions, testing and iterating along the way to ensure that
                the final product meets the needs of our users.
              </div>
          ...
          <div className="two-of-sixth">
            ...
            <div className="col-content">
              ...
              <div className="para-kick">
                <p className="another-para">
                  <span className="another-para">
                    Before diving into the design process, I like to start by
                    gathering as much information as possible about the project
                    at hand. To do this, I typically engage in two types of
                    research:
                    <br />
                  </span>
                  ...
                  <span className="another-para">
                    : It&#39;s also important to look at how other products have
                    tackled similar problems and gather inspiration from their
                    approaches. This helps me to understand what has already
                    been done so that I can design something that our users will
                    be able to learn quickly how to use at.
                  </span>
                </p>
              </div>
              <div className="qoute-text">
                <p className="black-qoute">
                  ...
                  <span className="black-qoute-text">
                    This means that users prefer your site to work the same way
              ...
              <div className="para-kick">
                <p className="another-para">
                  To understand how our users interact with other products, I
                  like to show the product managers examples of complex filters
                  that I find useful and have them use them while I observe.
                  This helps me to get a better understanding of the user
                  experience and identify any potential pain points.
                  <br />
                  <br />
                  Once I have gathered all of this information, I move on to the
                  fun part: sketching and planning. This is where I get to be
                  creative and start exploring different design concepts and
                  ideas.
                </p>
              </div>
            </div>
                ...
                <div className="inside-col-flex width-for-para">
                  ...
                  <div>
                    <p className="another-para-2 beh">
                      ...
                      <br />
                      Removing filters: by hovering over the filter, an X will
                      appear, clicking on the X will delete the filter
                      <br />
                      <br />
                      All filters should be URL-based, so the user can refresh
                      the page or send it to another person with the filters
                      applied.
                      <br />
                      after a filter was applied the user can remove it by
                      clicking a delete icon next to the filter in the filters
                      row.
                      <br />
                      once a filter was applied we should call a function or
                      submit a request ( architectural decision), but the
