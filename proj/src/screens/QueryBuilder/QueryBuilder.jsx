                ...
                <div className="col-content">
                  ...
                  <div>
                    <p className="another-para">
                      ...
                      providing advanced configuration options for the technical
                      users and keeping the interface easy to use for all users.
                      Too many options and possibilities could be overwhelming
                      and confusing.
                      <br />
                    ...
                    <div className="inside-col-flex width-for-para">
                      ...
                      <div>
                        <p className="another-para-2 beh">
                          Adding filters: by clicking a plus button a menu with
                          the filters types will pop.
                          <br />
                          Removing filters: by hovering over the filter, an X
                          will appear, clicking on the X will delete the filter
                          <br />
                          <br />
                          All filters should be URL-based, so the user can
                          refresh the page or send it to another person with the
                          filters applied.
                          <br />
                    ...
                    <div className="inside-col-flex width-for-para">
                      ...
                      <div>
                        <p className="another-para-2 beh">
                          ...
                          <br />
                          support multi-select both in the case of autocompleted
                          values and in the case of a fixed list, if something
                          is selected this should be indicated at the top of the
                          list with a selected checkbox so the user can uncheck
                          that.
                          <br />
                ...
                <div className="col-content">
                  ...
                  <div>
                    <p className="another-para">
                      ...
                      user experience, we conducted usability tests with a small
                      group of customers (typically 3-5 individuals). As a
                      small-medium startup, it&#39;s important for us to keep
                      our paying customers happy and make the most of every
                      testing opportunity. During these tests, we ask
                      participants to perform specific tasks that require the
                      use of the query builder, such as finding all identities
                      with access to an asset and filtering the inventory table.
                      We also gather feedback and ask for additional suggestions
                      for features or design improvements.
                      <br />
                      <br />
                      ...
                      definitions of each filter to the menu to help users
                      better understand their options and choose the right
                      filter for their needs.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="col-content">
                  ...
                  <div>
                    <p className="another-para">
                      ...
                      assets in tools like Figma to make it easy for developers
                      to find what they need.
                      <br />
                      <br />
                      Throughout the implementation process, I remain available
                      to provide support and clarification as needed. By working
                      closely with the development team, I am able to ensure
                      that the final product accurately reflects my design
                      vision and meets the needs of both the end users and the
                      developers.
                    </p>
                  </div>
                </div>
