                  ...
                  <div className="frame-6">
                    ...
                    <div className="group-5">
                      ...
                      <p className="propuesta-de-concept-2">
                        ...
                        for building a design system, I did my research by
                        reading multiple articles and watching Figma&#39;s
                        official tutorials. This research helped me to
                        understand the importance of using Figma&#39;s advanced
                        features in creating a user-friendly and easily
                        navigable system. The tutorials and articles provided me
                        with an in-depth understanding of how to use Figma&#39;s
                        features to create a design system that is both
                        functional and visually appealing. This research helped
                        me to develop a clear understanding of what features I
                        needed to include in my design system in order to make
                        it easy to use and navigate for the team.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="group-7">
                    <div className="frame-10">
                      ...
                      <p className="propuesta-de-concept-3">
                        ...
                        identifying the key design elements that were necessary
                        to effectively present the product&#39;s data and
                  ...
                  <div className="group-8">
                    <div className="frame-5">
                      ...
                      <p className="propuesta-de-concept-4">
                        ...
                        behaviors of the buttons are clearly displayed, making
                        it easy for users to understand and apply the
                        appropriate button for their design. One unique aspect
                        of this design system is the ability to change the state
                        of a button within the design itself, allowing for
                        instant updates and improved efficiency. Additionally,
                        the system includes functionalities for links and icons,
                        providing a comprehensive solution for all
                        button-related design needs. Overall, this design
                        system&#39;s button component is user-friendly,
              ...
              <div className="frame-15">
                <div className="group-11">
                  <p className="propuesta-de-concept-5">
                    ...
                    that heavily relies on tables to present data. I approached
                    this design by using atoms for different parameters such as
                    date, status, and name, and then built smart columns and
                    tables to make it easy to adjust the table to specific
                    design needs. One of the key features of this design is the
                    ability to easily adjust the columns size, making it easy to
                    create tables that are both functional and visually
                    appealing. The component is designed to be flexible and
                    adaptable, ensuring that it can meet the various design
                    needs of the different tables within the Authomize product.
                    This tables page is user-friendly and provides a
              ...
              <div className="frame-15">
                <div className="group-16">
                  <p className="propuesta-de-concept-6">
                    ...
                    dropdown page includes all the different states like
                    selected, hover, disabled and so on. The text input page
                    includes all the different sizes and states, like error,
                    disabled, and so on. This comprehensive approach ensures
                    that all input needs are met and that the design is
                    consistent and user-friendly. I also added guidelines for
                    how to place inputs in a form, indicates the spaces and
                    titles sizes needed.
                  </p>
                ...
                <div className="group-18">
                  <div className="frame-5">
                    ...
                    <p className="propuesta-de-concept-7">
                      ...
                      promotes consistency in design and facilitates
                      ...
                      asset to the company, streamlining the design process and
                      improving the overall user experience of Authomize&#39;s
                      product.
                    </p>
                  </div>
                </div>
